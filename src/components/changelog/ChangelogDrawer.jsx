...
import { X, Sparkles, CheckCircle2, Wrench, Rocket, ExternalLink } from "lucide-react";
import { useLanguage } from "@/contexts/LanguageContext";

export default function ChangelogDrawer({ isOpen, onClose, changelogs }) {
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  {language === "de" ? "Neueste Updates & Verbesserungen" : "Latest platform updates & releases"}
                </p>
              </div>
            </div>
            ...
            {filteredLogs.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-sm text-slate-400">
                  {language === "de" ? "Keine Updates in dieser Kategorie gefunden." : "No updates found in this category."}
                </p>
              </div>
            ) : (
