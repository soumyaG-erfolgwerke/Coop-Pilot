...
import { getAssignedCoopsAudit } from "../../lib/getCoopsService";
...
const CoopAuditView = (userId) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      setLoading(true);
      try {
        const allCoops = await getAssignedCoopsAudit(userId.userId);
