    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="space-y-6">
        ...
        <div className="p-3.5 border border-gray-200 dark:border-slate-700 rounded-lg bg-gray-50/50 dark:bg-slate-800/30 text-sm text-gray-600 dark:text-gray-400 leading-relaxed animate-fadeInUp">
          Easycoop partners with <span className="font-semibold text-gray-800 dark:text-slate-200">Stripe</span> for payment processing and secure payout routing. Please review the Stripe Connect Account Agreement and our internal guidelines before continuing.
        </div>
