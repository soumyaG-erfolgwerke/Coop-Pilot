...
const Page4 = ({ formData, handleChange, errors, selectedCooperative }) => {
        ...
        <div className="animate-fadeInUp">
          ...
          <div className="relative">
            ...
            <select
              ...
              } bg-white dark:bg-slate-700 rounded-md shadow-sm sm:text-sm transition-all duration-200 appearance-none`}
            >
        ...
        <div className="animate-fadeInUp">
          ...
          >
            ...
            {formData.boardMembers?.map((member, index) => {
              const isRegistered = registeredAdmins.includes(member.name);
              return (
                <option
                  key={index}
                  value={member.name}
