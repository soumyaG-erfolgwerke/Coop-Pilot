 ...
 * Clicking it or hitting Cmd+K/Ctrl+K opens the Global Search Command Palette modal.
 */
export default function GlobalSearchTrigger({ onClick }) {
  ...
  const placeholderText =
    language === "de"
      ? "Genossenschaft durchsuchen... (Mitglieder, Dokumente, Beschlüsse)"
      : "Search cooperative... (Members, documents, resolutions)";

  return (
    <button
      onClick={onClick}
      type="button"
      className="hidden md:flex items-center justify-between w-64 lg:w-96 px-3.5 py-2 text-sm text-gray-400 bg-gray-50 dark:bg-neutral-800/80 border border-gray-200 dark:border-neutral-700/80 rounded-xl hover:bg-white dark:hover:bg-neutral-800 hover:border-gray-300 dark:hover:border-neutral-600 transition-all group shadow-sm"
